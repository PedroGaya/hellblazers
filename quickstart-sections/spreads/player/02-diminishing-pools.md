...
A set of d6s used to track things like time, resources or effort. When **triggered**, roll the pool and **drop 1d for each 1-3 result**, or **drop a single die**. At 0d, the pool **clears** and the fiction changes.
...
If a triggered pool drops no die, you may drop one instead.
